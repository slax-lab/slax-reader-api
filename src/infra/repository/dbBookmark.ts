...
export class BookmarkRepo {
  ...
  public async deleteUserBookmark(bmId: number, userId: number): Promise<MultiLangError | null> {
    try {
      await this.prismaPg().s_user_delete_bookmark.delete({ where: { user_id_bookmark_id: { user_id: Number(userId), bookmark_id: Number(bmId) } } })
    } catch (e) {
    ...
    try {
      await this.prismaPg().s_user_bookmark_tag.deleteMany({ where: { bookmark_id: Number(bmId), user_id: Number(userId) } })
      await this.prismaPg().s_user_bookmark.delete({ where: { user_id_bookmark_id: { bookmark_id: Number(bmId), user_id: Number(userId) } } })
      return null
    } catch (err) {
  ...
  public async updateBookmarkDeleteAt(bmId: number, userId: number, isDeleted: boolean) {
    ...
    if (isDeleted) {
      deleteTasks.push(
        this.prismaPg().s_user_delete_bookmark.create({
          data: {
            user_id: userId,
            bookmark_id: bmId,
            deleted_at: date
      ...
      deleteTasks.push(this.prismaPg().s_user_delete_bookmark.delete({ where: { user_id_bookmark_id: { user_id: userId, bookmark_id: bmId } } }))
    }

    deleteTasks.push(
      this.prismaPg().s_user_bookmark.update({
    ...
    deleteTasks.push(
      this.prismaPg().s_user_bookmark_tag.updateMany({
  ...
  public async deleteBookmarkTry(bmId: number, userId: number): Promise<bookmarkPO | null> {
    try {
      const bookmark = await this.prismaPg().s_bookmark.findUnique({ where: { id: bmId } })
      if (!bookmark || bookmark.private_user !== userId) return null

      await this.prismaPg().$executeRaw`DELETE FROM s_bookmark WHERE id = ${bmId}`
  ...
  public async getBookmarkById(bmId: number) {
    try {
      return await this.prismaPg().s_bookmark.findFirst({ where: { id: bmId } })
    } catch (err) {
  ...
  public async getBookmark(targetUrl: string, privateUser: number): Promise<bookmarkPO | null> {
    const res = await this.prismaPg().s_bookmark.findFirst({
      where: {
  ...
  public async getUserBookmark(bmId: number, userId: number) {
    return await this.prismaPg().s_user_bookmark.findFirst({ where: { bookmark_id: bmId, user_id: userId } })
  }

  public async getUserBookmarkById(id: number) {
    return await this.prismaPg().s_user_bookmark.findFirst({ where: { id } })
  }

  public async getUserBookmarkByUserBmId(userBmId: number) {
    return await this.prismaPg().s_user_bookmark.findFirst({ where: { id: userBmId }, include: { bookmark: true } })
  }

  public async getUserBookmarkWithDetail(bmId: number, userId: number) {
    try {
      return await this.prismaPg().s_user_bookmark.findFirst({
        where: { bookmark_id: bmId, user_id: userId },
  ...
  public async createBookmark(info: bookmarkPO, status: string) {
    return await this.prismaPg().s_bookmark.upsert({
  ...
  public async createBookmarkRelation(userId: number, bmId: number, type: number, isArchive: boolean) {
    return await this.prismaPg().s_user_bookmark.upsert({
      where: { user_id_bookmark_id: { user_id: userId, bookmark_id: bmId } },
  ...
  public async listAllUserBookmarks(userId: number) {
    return await this.prismaPg().s_user_bookmark.findMany({ where: { user_id: userId, deleted_at: null } })
  }

  public async listUserStarBookmarksByTargetUser(userId: number, offset: number, limit: number, subscribeEndTime: Date) {
    return await this.prismaPg().s_user_bookmark.findMany({
  ...
  public async listUserBookmarksByTagId(userId: number, tagId: number, offset: number, limit: number) {
    return await this.prismaPg().s_user_bookmark_tag.findMany({
      where: {
        user_id: userId,
        tag_id: tagId,
        is_deleted: false
  ...
  public async updateBookmark(bmId: number, info: bookmarkParsePO) {
    return await this.prismaPg().s_bookmark.update({ where: { id: bmId }, data: { updated_at: new Date(), ...info } })
  }

  public async upsertBookmarkSummary(info: bookmarkSummaryPO) {
    const { bookmark_id, lang, user_id, ...infoWithoutIds } = info
    return await this.prismaPg().s_bookmark_summary.upsert({
  ...
  public async deleteBookmarkSummary(bmId: number, userId: number) {
    return await this.prismaPg().s_bookmark_summary.deleteMany({ where: { bookmark_id: bmId, user_id: userId } })
  }

  public async updateBookmarkIsRead(bmId: number, userId: number) {
    await this.prismaPg().s_user_bookmark.update({
      where: { user_id_bookmark_id: { user_id: userId, bookmark_id: bmId } },
      data: { is_read: true }
    })
  }
  ...
  public async updateBookmarkStarStatus(bmId: number, userId: number, status: boolean) {
    return await this.prismaPg().s_user_bookmark.update({
      where: { user_id_bookmark_id: { user_id: userId, bookmark_id: bmId } },
  ...
  public async updateBookmarkStatus(bmId: number, status: queueStatus) {
    return await this.prismaPg().s_bookmark.update({ where: { id: bmId }, data: { status, updated_at: new Date() } })
  }
  ...
  public async updateUserBookmarkBookmarkId(id: number, bookmarkId: number) {
    return await this.prismaPg().s_user_bookmark.update({ where: { id }, data: { bookmark_id: bookmarkId, updated_at: new Date() } })
  }

  public async getBookmarkShareByBookmarkId(bmId: number, userId: number) {
    return await this.prismaPg().s_bookmark_share.findFirst({ where: { bookmark_id: bmId, user_id: userId } })
  }

  public async deleteBookmarkShare(bmId: number, userId: number) {
    try {
      await this.prismaPg().s_bookmark_share.delete({ where: { bookmark_id_user_id: { bookmark_id: bmId, user_id: userId } } })
    } catch (err) {
  ...
  public async updateBookmarkShareIsEnable(bmId: number, userId: number, isEnable: boolean) {
    return await this.prismaPg().s_bookmark_share.update({
  ...
  public async getBookmarkShareByShareCode(shareCode: string) {
    return await this.prismaPg().s_bookmark_share.findFirst({ where: { share_code: shareCode } })
  }
  ...
  public async createBookmarkShare(shareCode: string, userId: number, bmId: number, showCommentLine: boolean, showUserinfo: boolean, allowAction: boolean) {
    try {
      return await this.prismaPg().s_bookmark_share.create({
        data: {
  ...
  public async createUserTag(userId: number, tag: string) {
    if (!tag) return
    return this.prismaPg().s_user_tag.upsert({
      where: {
        user_id_tag_name: {
          user_id: userId,
          tag_name: tag
  ...
  public async createUserTags(userId: number, tags: string[]) {
    ...
    return this.prismaPg().s_user_tag.createManyAndReturn({
      data: tags.map(tag => ({
        user_id: userId,
        tag_name: tag,
        created_at: new Date(),
  ...
  public async updateUserTagDisplay(userId: number, tagId: number, display: boolean) {
    return await this.prismaPg().s_user_tag.update({
  ...
  public async createBookmarkTag(bmId: number, userId: number, tagId: number, tagName: string) {
    return await this.prismaPg().s_user_bookmark_tag.upsert({
  ...
  public async deleteBookmarkTag(bookmarkId: number, userId: number, tagId: number) {
    return await this.prismaPg().s_user_bookmark_tag.delete({
  ...
  public async deleteUserTag(userId: number, tagId: number) {
    return await this.prismaPg().s_user_tag.update({ where: { id: tagId, user_id: userId }, data: { display: false } })
  }

  public async getBookmarkTags(userId: number, bookmarkId: number) {
    return await this.prismaPg().s_user_bookmark_tag.findMany({ where: { bookmark_id: bookmarkId, user_id: userId } })
  }

  public async getUserTags(userId: number) {
    return await this.prismaPg().s_user_tag.findMany({ where: { user_id: userId } })
  }

  public async getUserTagById(userId: number, tagId: number) {
    return await this.prismaPg().s_user_tag.findFirst({ where: { id: tagId, user_id: userId } })
  }

  public async updateUserTag(userId: number, tagId: number, tagName: string) {
    return await this.prismaPg().s_user_tag.update({ where: { id: tagId, user_id: userId }, data: { tag_name: tagName } })
  }

  public async updateBookmarkTag(userId: number, tagId: number, tagName: string) {
    await this.prismaPg().s_user_bookmark_tag.updateMany({ where: { tag_id: tagId, user_id: userId }, data: { tag_name: tagName } })
  }

  public async createBookmarkOverview(userId: number, bookmarkId: number, overview: string, content: string) {
    return await this.prismaPg().s_user_bookmark_overview.create({
      data: {
        user_id: userId,
  ...
  public async getUserBookmarkOverview(userId: number, bookmarkId: number) {
    return await this.prismaPg().s_user_bookmark_overview.findFirst({
      where: {
        user_id: userId,
        bookmark_id: bookmarkId
      },
  ...
  public async createBookmarkImportTask(userId: number, type: string, objectKey: string, totalCount: number, batchCount: number) {
    return await this.prismaPg().s_bookmark_import.create({
      data: {
        user_id: userId,
        type,
  ...
  public async appendImportTaskErrLog(importId: number, errLog: string) {
    this.prismaPg().$executeRaw`UPDATE s_bookmark_import SET reason = CONCAT(reason, '\n', ${errLog}) WHERE id = ${importId}`
  }

  public async getUserImportTask(userId: number) {
    return await this.prismaPg().s_bookmark_import.findMany({ where: { user_id: userId } })
  }

  public async getUnfinishedImportTask() {
    return await this.prismaPg().s_bookmark_import.findMany({ where: { status: 1 } })
  }

  public async updateBookmarkImportTask(importId: number, status: number, reason: string) {
    return await this.prismaPg().s_bookmark_import.update({
      where: { id: importId },
      data: { status, reason }
    })
  }
  ...
  public async getUserImportTaskByType(userId: number, type: string) {
    return await this.prismaPg().s_bookmark_import.findMany({
      where: {
        user_id: userId,
        type,
        status: {
  ...
  public async getExpiredTrashedBookmark() {
    return await this.prismaPg().s_user_delete_bookmark.findMany({
      where: { deleted_at: { lte: new Date(Date.now() - 7 * 24 * 60 * 60 * 1000) } }
    })
  }

  public async batchGetBookmarkComment(commentIds: number[]) {
    return await this.prismaPg().s_mark_comment.findMany({ where: { id: { in: commentIds } } })
  }

  public async batchGetBookmarkTitle(bookmarkIdList: number[]): Promise<bookmarkTitlePO[]> {
    return await this.prismaPg().$queryRaw<bookmarkTitlePO[]>`SELECT title, u.id as user_bookmark_id FROM s_bookmark b 
      INNER JOIN s_user_bookmark u on b.id = u.bookmark_id
      WHERE u.id in (${Prisma.join(bookmarkIdList)})`
  }

  public async getUserBookmarkSummary(bookmarkId: number, userId: number, lang: string) {
    return await this.prismaPg().s_bookmark_summary.findFirst({
      where: {
        bookmark_id: bookmarkId,
        user_id: userId,
        lang
  ...
  public async getBookmarkSummariesRaw(bookmarkId: number, lang: string, userId: number, limit: number) {
    return await this.prismaPg().$queryRaw<bookmarkSummaryPO[]>`
      SELECT * FROM (SELECT * FROM s_bookmark_summary WHERE user_id = ${userId} AND bookmark_id = ${bookmarkId} AND lang = ${lang} LIMIT ${limit})
      UNION ALL
      SELECT * FROM (SELECT * FROM s_bookmark_summary WHERE bookmark_id = ${bookmarkId} AND lang = ${lang} LIMIT ${limit})
    `
  }

  public async createBookmarkFetchRetry(bookmarkId: number, userId: number, retryCount?: number) {
    return await this.prismaPg().s_bookmark_fetch_retry.upsert({
  ...
  public async getFilterBookmarkFetchRetries(options: { status: bookmarkFetchRetryStatus }) {
    ...
    SELECT  bookmark_id, group_concat(retry_count) as retry_counts, group_concat(user_id) as user_ids, created_at FROM s_bookmark_fetch_retry 
  ...
  public async updateBookmarkFetchRetry(bookmarkId: number, options: { retry_count?: number; last_retry_at?: Date; status?: bookmarkFetchRetryStatus; trace_id?: string }) {
    return await this.prismaPg().s_bookmark_fetch_retry.updateMany({
  ...
  public async upsertVectorShard(bookmarkId: number, shardIdx: number) {
    return await this.prismaPg().s_bookmark_vector_shard.upsert({
      where: { bookmark_id: bookmarkId },
  ...
  public async getVectorShard(bookmarkId: number) {
    return await this.prismaPg().s_bookmark_vector_shard.findFirst({ where: { bookmark_id: bookmarkId } })
  }
  ...
  public async getBookmarkVectorShard(userId: number) {
    ...
    try {
      return await this.prismaPg().$queryRaw<bookmarkShardPO[]>`SELECT id, vs.bookmark_id, vs.bucket_idx, vs.created_at FROM s_bookmark_vector_shard vs
      INNER JOIN (SELECT bookmark_id FROM s_user_bookmark WHERE user_id = ${userId}) ub on vs.bookmark_id = ub.bookmark_id`
    } catch (e) {
  ...
  public async getUserBookmarkIds(userId: number) {
    return await this.prismaPg().s_user_bookmark.findMany({ where: { user_id: userId }, select: { bookmark_id: true } })
  }
  ...
  public async getAllBookmarkChanges(userId: number) {
    try {
      ...
      FROM s_bookmark sb 
      INNER JOIN 
      (SELECT id, bookmark_id, user_id, created_at FROM s_user_bookmark WHERE user_id = ${userId}) ub 
  ...
  public async createBookmarkChangeLog(userId: number, url: string, bookmarkId: number, action: 'add' | 'delete' | 'update', time: Date) {
    try {
      return await this.prismaPg().s_user_bookmark_change.create({
        data: {
          user_id: userId,
          target_url: url,
          bookmark_id: bookmarkId,
  ...
  public async getPartialBookmarkChanges(userId: number, time: number) {
    const res = await this.prismaPg().s_user_bookmark_change.findMany({
      where: {
        user_id: userId,
        created_at: {
          gt: new Date(time)
  ...
  public async upsertBookmarkTags(bmId: number, userId: number, tags: { id: number; tag_name: string }[]) {
    return await this.prismaPg().$executeRaw`
      INSERT INTO s_user_bookmark_tag(user_id, bookmark_id ,tag_id, tag_name, created_at)
  ...
  public async updateUserTagsDisplay(userId: number, names: string[]) {
    return await this.prismaPg().$queryRaw<{ id: number; tag_name: string }[]>`
      INSERT INTO s_user_tag(user_id, tag_name, display) 
